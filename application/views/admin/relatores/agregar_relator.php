...
';
	...
	'ops'	=> $opciones,
	'miga' => '<a href="relatores/">relatores</a> | <strong>Agregar</strong>'
	);	 	
...
?>
	<div class="section">
		...
		<div id="edit_form">
			...
			<?php echo form_open_multipart('relatores/agregar/'); ?>
			
			<label><strong>E-mail</strong></label>						
			<?php echo form_input('email', set_value('email'),'class="inputclass"');?><span class="rojo">*</span>
						
			<br />
			
			<label><strong>Nombre Completo</strong></label>					
			<?php echo form_input('nombre_completo', set_value('nombre_completo'),'class="inputclass"');?><span class="rojo">*</span>			
			
			<br />

									
			<label><strong>Contraseña</strong></label>						
			<?=form_password('contrasena','','class="inputclass"');?><span class="rojo">*</span>
			
			<br />
				
			<label><strong>Sitio Web</strong></label>					
			<?php echo form_input('sitio_web', set_value('sitio_web'),'class="inputclass"');?>			
			
			<br />
			<label><strong>Imágen Perfil</strong></label>
			...
			<?php echo form_textarea('biografia', set_value('biografia'),' class="tinymce" ');?>			
			
		<br>
			
			<br />
					
			<?php echo form_submit('agregar_relator','Guardar','id="save"  class="loginbutton" class="submit"');?>
				
					
			<?php echo form_close(); ?>
			<span class="rojo">(*)</span> Campos Obligatorios 
		</div>	
