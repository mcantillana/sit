...
';
	...
	$opciones = Array(
 	...
 	$editar_a = "Editar: ".$taller->nombre;
 	$data	=	array(
	'titulo' => $editar_a,
	'icono' => 'icon-48-menumgr',
	'ops'	=> $opciones,
	'miga' => '<a href="talleres/">talleres</a> | <strong>editar</strong>'
	);	 		
?>
	<div class="section">
		...
		<div id="edit_form">
			...
			<?php echo form_open('talleres/editar/'.$taller->id_taller); ?>
		
			
			
			<label><strong>ID</strong></label>						
			<?php echo form_input('id_taller', $taller->id_taller,'class="inputclass" disabled="disabled" style="color:#000"');?>
			
			<br />
			
			<label><strong>Nombre</strong></label>						
			<?php echo form_input('nombre', $taller->nombre,'class="inputclass"');?>
						
			<br />
			
			<label><strong>Requisitos</strong></label>					
			<?php echo form_input('requisitos', $taller->requisitos,'class="inputclass"');?>			
			...
			<?php 					
				...
				echo form_dropdown('nivel', $options, $taller->nivel);
			...
			<?php echo form_textarea('descripcion', $taller->descripcion,' class="tinymce" ');?>			
