...
';
	...
	'icono' => 'icon-48-category-add',
	'ops'	=> $opciones,
	'miga' => '<a href="categorias/">categorías</a> | <strong>Agregar</strong>'
	);	 	
...
?>
	<div class="section">
		...
		<div id="edit_form">
			...
			<?php echo form_open('categorias/agregar/'); ?>
			
			<label><strong>Nombre</strong></label>						
			<?php echo form_input('nombre', set_value('nombre'),'class="inputclass"');?>
					
			<br />
			<div class="col w150" style="font-size:14px;margin-top:5px;"><strong>Descripción</strong></div>
			<div class="col w700"><?php echo form_textarea('descripcion', set_value('descripcion'),' style="height:100px" ');?></div>
			
			<br />
					
			<?php echo form_submit('agregar_categoria','Guardar','id="save"  class="loginbutton" class="submit"');?>
